package nolanjames.me.repository

import nolanjames.me.models.ApiResponse
import nolanjames.me.models.Hero
...
class HeroRepositoryImpl : HeroRepository {
    ...
    private fun findHeroes(query: String?): List<Hero> =
        if (query.isNullOrEmpty()) emptyList()
        else heroes.values.flatten().filter { it.name.contains(query, ignoreCase = true) }
